...
[NOTE]
====
Play 2.6 has a more modular architecture and, because of that, you may need to add some dependencies manually. For example, https://playframework.com/documentation/2.6.x/Migration26#Guice-DI-support-moved-to-separate-module[Guice supported was moved to a separated module]. Considering the following definition for a Play 2.6 project:
